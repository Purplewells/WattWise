...
namespace WattWise.Migrations
{
    ...
    [Migration("20250430145702_ChangeMeterUsageToMeterReading")]
    partial class ChangeMeterUsageToMeterReading
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WattWise.Models.MeterReading", b =>
                {
            ...
            modelBuilder.Entity("WattWise.Models.Notification", b =>
                {
            ...
            modelBuilder.Entity("WattWise.Models.NotificationType", b =>
                {
                    b.Property<int>("NotificationTypeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WattWise.Models.Meter", b =>
                {
                    b.HasOne("WattWise.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("Meters")
            ...
            modelBuilder.Entity("WattWise.Models.MeterReading", b =>
                {
                    ...
                    b.HasOne("WattWise.Models.MeterUsageStatus", null)
            ...
            modelBuilder.Entity("WattWise.Models.Notification", b =>
                {
                    ...
                    b.HasOne("WattWise.Models.NotificationType", "NotificationType")
                        .WithMany()
