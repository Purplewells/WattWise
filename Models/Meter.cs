...
namespace WattWise.Models
{
    ...
    public class Meter
    {
        ...
        [Required]
        public required string Location { get; set; } = "Unknown"; // Location of the meter, e.g., "Living Room", "Kitchen", etc.
        ...
        public required ICollection<Transaction> Transaction { get; set; } = new List<Transaction>();
        public required ICollection<Alert> Alert { get; set; } = new List<Alert>();
        public required ICollection<MeterUsage> UsageData { get; set; } = new List<MeterUsage>();
